...
import { developerDestination } from '../../lib/app-platform/access-routing.mjs';
...
export default function LoginPage() {
  ...
  const returnTo = developerDestination(searchParams.get('next') ?? '/overview');

  useEffect(() => {
    const controller = new AbortController();
    void appPlatformClient.getSession(controller.signal).then(() => window.location.replace(returnTo)).catch(() => {});
